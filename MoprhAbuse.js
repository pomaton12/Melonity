...
/***/ (() => {
	...
	MorphlingUltiAbuse.OnUpdate = () => {
        ...
        if (localHero && isUiEnabled.GetValue()) {			
			...
			let imgMorph = Renderer.LoadImage("panorama/images/heroes/npc_dota_hero_antimage_loadout_png.vtex_c");
			...
			Renderer.SetDrawColor(255, 255, 255, visibility);
			Renderer.DrawText(font2, Math.ceil(xpos)-5, Math.ceil(ypos)-30, "Ability Cast Select");
