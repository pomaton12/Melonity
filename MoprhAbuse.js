        ...
        if (localHero && isUiEnabled.GetValue()) {
            ...
            if (comboTarget) {
                if (!particle) {
					...
					particle = Particle.Create("particles/econ/events/fall_2022/mekanism/mekanism_recipient_fall2022.vpcf", Enum.ParticleAttachment.PATTACH_INVALID, comboTarget);
