        ...
        if (localHero && isUiEnabled.GetValue()) {
            ...
            if (comboTarget) {
                if (!particle) {
					...
					particle = Particle.Create("particles/units/heroes/hero_spirit_breaker/spirit_breaker_charge_target_mark.vpcf", Enum.ParticleAttachment.PATTACH_OVERHEAD_FOLLOW, comboTarget);
